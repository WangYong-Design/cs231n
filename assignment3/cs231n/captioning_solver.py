    ...
    def train(self):
        ...
        for t in range(num_iterations):
            ...
            if self.verbose and t % self.print_every == 0:
                ...
                # learning rate.
                first_epoch, last_epoch = t == 0, t == (num_iterations - 1)
                ...
                if first_epoch or epoch_end or last_epoch:
                    train_acc = self.check_accuracy(self.data["train_features"],
                                                    self.data["train_captions"], self.num_train_sample)
                    val_acc = self.check_accuracy(self.data["val_features"], self.data["val_captions"])
                    ...
                    # Keep the best_val model's params
